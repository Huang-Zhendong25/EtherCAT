...
#define ECAT_TIMER_INC_P_MS                ECAT_TIM_INC_P_MS /**< \brief ECAT_TIM_INC_P_MS ticks per ms*/
//CHANGE_END
...
-----------------------------------------------*/
//YXY_TEST
extern volatile BOOL ESC_Int;
extern void EXTINT_SET(void);
extern void EXTINT_RESET(void);
//YXY_CHANGE:HW_ESC_INT
//CHANGE_START
#ifndef DISABLE_ESC_INT
#define    DISABLE_ESC_INT()            {escDisable();} /**< \brief Disable interrupt source INT1*/
#define    DISABLE_ESC_INT1()            {escDisable();ESC_Int = FALSE;EXTINT_RESET();} /**< \brief Disable interrupt source INT1*/
#endif
#ifndef ENABLE_ESC_INT
#define    ENABLE_ESC_INT()             {escEnable();} /**< \brief Enable interrupt source INT1*/
#define    ENABLE_ESC_INT1()             {escEnable();ESC_Int = TRUE;EXTINT_SET();} /**< \brief Enable interrupt source INT1*/
#endif

#ifndef HW_GetTimer
#define HW_GetTimer()          (UINT32)timer3Get() /**< \brief Access to the hardware timer*/
#endif

#ifndef HW_ClearTimer
#define HW_ClearTimer()        timer3Clear() /**< \brief Clear the hardware timer*/
#endif
...
#if defined(_HARDWARE_) && (_HARDWARE_ == 1)
    #define PROTO
#else
    #define PROTO extern
#endif
