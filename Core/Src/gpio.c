...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_STATE1_Pin|LED_STATE2_Pin|SPI1_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DRIVER_CONTROL3_Pin|LDAC_Pin|DRIVER_CONTROL2_Pin|DRIVER_CONTROL1_Pin, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(GPIOB, LDAC_Pin, GPIO_PIN_RESET);
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI_SEL_GPIO_Port, SPI_SEL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EEPROM_LOADED_GPIO_Port, EEPROM_LOADED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = LED_STATE1_Pin|LED_STATE2_Pin|SPI1_CS_Pin;
  ...
  GPIO_InitStruct.Pin = DRIVER_CONTROL3_Pin|DRIVER_CONTROL2_Pin|DRIVER_CONTROL1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
